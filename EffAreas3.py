...
A_muon_1 = log_interp(master, E_grid_radio, A_mu_radio)
A_muon_2 = log_interp(master, E_icmuon_interp, ice_cube_muon)
A_muon = A_muon_1+A_muon_2 

A_tau_1 = log_interp(master, E_grid_radio, A_tau_radio)
A_tau_2 = log_interp(master, E_icet_interp, ice_cube_tau)
A_tau_3 = log_interp(master, E_tambo, A_tambo_tau)
A_tau_4 = log_interp(master, E_grand_interp, A_grand_interp)
A_tau_5 = log_interp(master, E_trinity_interp, A_trinity_interp)
A_tau_6 = log_interp(master, E_poemma_interp, A_poemma_interp)
A_tau = A_tau_1+A_tau_2+A_tau_3+A_tau_4+A_tau_5+A_tau_6

A_e_1 = log_interp(master, E_grid_radio, A_e_radio)
A_e_2 = log_interp(master, E_icet_interp, ice_cube_e)
A_e_3 = log_interp(master, E_tambo,  A_tambo_e)
A_e = A_e_1+A_e_2 + A_e_3

print (A_e)

errorline(ax_left,  master,   A_muon,      "Muon")
errorline(ax_left,  master,   A_tau,      "Taon")
errorline(ax_left,  master,   A_e,      "Electron")
...
# Usage:
save_csv("effareasmc.csv", master, A_muon, A_tau, A_e)